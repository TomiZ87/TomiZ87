...
- Swimming data reader/analyser/analytics from Strava/Apple Health (+ Food/Calorie Tracker with TUI) (Food Tracker ON HOLD)
- CLI tool for productivity in Rust (PUT ON HOLD)
- HomeLab Setup (with NAS and useful services for every day use) (PUT ON HOLD)
- Interactive Map of Tram Accessibility for Wheelchair users - Bratislava (hopefully SOON)
...
- **Tools:** Git, Docker, Jekyll, VS Code, Express.js, Vue.js, BootstrapVueNext, PostgreSQL, MongoDB + Learning NVIM

---

## ⚙️ GitHub Stats
<div class='container'>
  <img style="height: auto; width: 55%;" class="img" src="https://github-readme-stats.vercel.app/api?username=tomiz87&show_icons=true&theme=blue-green" />
  &nbsp;
  &nbsp;
  <img style="height: auto; width: 40%;" class="img" src="https://github-readme-stats.vercel.app/api/top-langs/?username=tomiz87&theme=blue-green&langs_count=8&layout=compact" /></div>
</div>
